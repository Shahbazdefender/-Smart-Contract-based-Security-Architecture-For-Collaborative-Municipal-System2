...
<html>
	<head>
		...
		<title><strong>Smart Meter</strong></title>
		<!--
...
p {text-align: center;}
			...
			<h1><a href="./"><strong>Smart Meter</strong></a><?php if (strlen($name)) { ?>  <?php ?><?php } ?></h1>
<?php
	if (strlen($chain)) {
		$name=@$config[$chain]['name'];
?>
			...
			<nav class="navbar navbar-inverse">
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li><a href="./?chain=<?php echo html($chain)?>&page=issue" class="pair-first">Configration</a></li>
						<li><a href="./?chain=<?php echo html($chain)?>&page=update" class="pair-second">| Update</a></li>
						<li><a href="./?chain=<?php echo html($chain)?>&page=send">Registration</a></li>
						<li><a href="./?chain=<?php echo html($chain)?>&page=send2">Usecase-Detail</a></li>
						...
						<li><a href="./?chain=<?php echo html($chain)?>&page=issue2" >Configration2</a></li>						
...
?>
			<p class="lead"><br/>Start Distributed Smart Meter Front Panel</p>
